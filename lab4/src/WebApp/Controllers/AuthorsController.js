...
const { AuthorPostBody, AuthorPutBody } = require('../Models/Author.js');
...
Router.post('/', async (req, res) => {
    ...
    ResponseFilter.setResponseDetails(res, 201, author, req.originalUrl);
});
...
Router.get('/:id', async (req, res) => {
    ...
    ResponseFilter.setResponseDetails(res, 200, author);
});
